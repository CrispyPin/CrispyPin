...
pacmd load-module module-null-sink sink_name="vsink_voice_vr"
pacmd load-module module-loopback source=$MIC_VR sink="vsink_voice_vr"
...
pacmd load-module module-combine-sink sink_name="vsink_stream_vr" slaves="vsink_desktop","vsink_voice_vr"
...
pacmd load-module module-remap-source source_name="vmic_stream_vr" master=vsink_stream.monitor source_properties=device.description="Stream_mic_VR"
